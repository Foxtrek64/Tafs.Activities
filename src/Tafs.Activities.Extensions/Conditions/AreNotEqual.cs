...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    /// <summary>
    /// Ensures the provided <typeparamref name="TEntity"/> values are not equal using the provided
    /// <see cref="EqualityComparer"/>.
    /// </summary>
    /// <typeparam name="TEntity">The type of entity to compare.</typeparam>
    [Description("Accepts two variables of the same type to evaluate them for inequality.")]
    public sealed class AreNotEqual<TEntity> : CodeActivity<bool>
    {
        /// <summary>
