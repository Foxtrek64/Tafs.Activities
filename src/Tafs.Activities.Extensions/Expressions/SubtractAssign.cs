...
namespace Tafs.Activities.Extensions.Expressions
{
...
#endif
    {
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            if (IsChecked)
            {
                SubtractAssign<TLeft, TRight, TResult>.EnsureOperationFunction(metadata, ref checkedOperationFunction, ExpressionType.SubtractAssignChecked);
            }
            else
            {
                SubtractAssign<TLeft, TRight, TResult>.EnsureOperationFunction(metadata, ref uncheckedOperationFunction, ExpressionType.SubtractAssign);
            }
        }
